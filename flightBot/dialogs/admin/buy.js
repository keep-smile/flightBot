...
const ADMIN_DIALOG = 'profileDialog';
const BUY_DIALOG = 'profileDialog';
const TICKETS_DIALOG = 'profileDialog';

// Prompt IDs
const FNAME_PROMPT = 'fNamePrompt';
const LNAME_PROMPT = 'lNamePrompt';
const CITY_FROM_PROMPT = 'cityFromPrompt';
const CITY_TO_PROMPT = 'cityToPrompt';
const TICKET_CLASS_PROMPT = 'ticketClassPrompt';
const ADMIN_LOGIN_PROMPT = 'adminLoginPrompt';
const ADMIN_PASSWORD_PROMPT = 'adminPasswordPrompt';
